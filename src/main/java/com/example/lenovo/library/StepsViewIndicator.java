...
public class StepsViewIndicator extends View
{
    ...
    private static final int dot_SIZE = 100;
    private Paint paint;
     ...
     * 已经完成部分的颜色
     *  Color.GREEN;
     * 25cdc9 Color.FromArgb(0xFFFFFF)
     */
    //private int mThumbColor =Color.GREEN;
    int mThumbColor =HextoColor("#25cdc9");
    /**
     * 将十六进制 颜色代码 转换为 int
     *
     * @return
    ...
    private void init()
    {
        ...
        mThumbRadius = 0.4f * dot_SIZE;
        mCircleRadius = 0.7f * mThumbRadius;
        mPadding = 0.5f * dot_SIZE;
