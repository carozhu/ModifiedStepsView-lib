...
public class StepsView extends LinearLayout implements StepsViewIndicator.OnDrawListener
{
    ...
    private int munCompletedPosition;
    ...
    public StepsView setErrorIndicator(int errorIndicator)
    {
        mStepsViewIndicator.setErrorPosition(errorIndicator);
        return this;
    }
...
//                    textView.setX(indicatorPosition.get(i)-textView.getWidth());
//                }else {
...
//        }
        ...
        if (mLabels != null)
        {
            for (int i = 0; i < mLabels.length; i++)
            {
                ...
                mLabelsLayout.addView(textView,p);
            }
        }
